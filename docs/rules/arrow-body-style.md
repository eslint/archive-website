...
layout: doc
edit_link: https://github.com/eslint/eslint/edit/main/docs/rules/arrow-body-style.md
...
* [Documentation source](https://github.com/eslint/eslint/tree/HEAD/docs/rules/arrow-body-style.md)
