...
**Deprecation notice**: This rule is deprecated and has been superseded by the [strict](strict.html) rule. It will be removed in ESLint v1.0. `"global"` mode in the strict rule is most similar to this rule.
