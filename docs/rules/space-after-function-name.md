...
**Deprecation notice**: This rule is deprecated and has been superseded by the [space-before-function-parentheses](space-before-function-parentheses.html) rule. It will be removed in ESLint v1.0.
