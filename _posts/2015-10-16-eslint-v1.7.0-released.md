...
We just pushed ESLint v1.7.0, which is a minor release upgrade of ESLint. This release adds some new features fixes several bugs found in the previous release.
...
* New: no-magic-number rule (fixes [#4027](https://github.com/eslint/eslint/issues/4027)) (Vincent Lemeunier)
