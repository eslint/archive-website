...
This release contains a new Suggestions API for rule authors and integrations. We're looking forward to seeing  You can read more about this exciting new feature [here](/docs/developer-guide/working-with-rules#providing-suggestions).
