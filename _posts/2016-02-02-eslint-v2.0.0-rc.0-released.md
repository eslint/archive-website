...
We just pushed ESLint v2.0.0-rc.0, which is a preview release upgrade of ESLint. As such, we have duplicated some of the content from the previous blog posts to make it easier to understand the differences between v1.10.3 and this version.
...
* [`newline-per-chained-call`](http://eslint.org/docs/2.0.0/rules/newline-per-chained-call)
* [`no-confusing-arrow`](http://eslint.org/docs/2.0.0/rules/no-confusing-arrow)
* [`no-extra-label`](http://eslint.org/docs/2.0.0/rules/no-extra-label)
...
* [`no-self-assign`](http://eslint.org/docs/2.0.0/rules/no-self-assign)
* [`no-unmodified-loop-condition`](http://eslint.org/docs/2.0.0/rules/no-unmodified-loop-condition)
* [`no-unused-labels`](http://eslint.org/docs/2.0.0/rules/no-unused-labels)
...
* [`template-curly-spacing`](http://eslint.org/docs/2.0.0/rules/template-curly-spacing)
