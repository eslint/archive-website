...
teaser: "We just pushed ESLint v2.0.0-alpha-2, which is a preview release upgrade of ESLint. As such, we have duplicated some of the content from the v2.0.0-alpha-1 announcement to make it easier to understand the differences between v1.10.3 and this version."
