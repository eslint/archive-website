...
We just pushed ESLint 1.0.0-rc-3, which is the second release candidate for 1.0.0. As such, we have duplicated some of the content from the 1.0.0-rc-2 and 1.0.0-rc-1 announcements to make it easier to understand the differences between 0.24.1 and this version.
