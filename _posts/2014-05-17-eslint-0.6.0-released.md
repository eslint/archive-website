...
* [brace-style](http://eslint.org/docs/rules/brace-style.html) now disallows block statements where curlies are on the same line. While not strictly a breaking change, it is a significant enough change to warrant being called out in this way. ([#758](https://github.com/eslint/eslint/issues/758))
* Node 0.8.x is no longer officially supported as of 0.6.0. We will no longer accept or fix bugs for Node 0.8.x.

## Rules

* **Breaking:** [brace-style](http://eslint.org/docs/rules/brace-style.html) now disallows block statements where curlies are on the same line. While not strictly a breaking change, it is a significant enough change to warrant being called out in this way. ([#758](https://github.com/eslint/eslint/issues/758))
* **New:** [default-case](http://eslint.org/docs/rules/default-case.html) ([#787](https://github.com/eslint/eslint/issues/787))
* **New:** [no-new-require](http://eslint.org/docs/rules/no-new-require.html) ([#847](https://github.com/eslint/eslint/issues/847))
* **New:** [space-after-keywords](http://eslint.org/docs/rules/space-after-keywords.html)  ([#807](https://github.com/eslint/eslint/issues/807))
* **New:** [no-lonely-if](http://eslint.org/docs/rules/no-lonely-if.html) (fixes [#790](https://github.com/eslint/eslint/issues/790)) (Brandon Mills)
* **New:** [no-restricted-modules](http://eslint.org/docs/rules/no-restricted-modules.html) ([#791](https://github.com/eslint/eslint/issues/791))
* **New:** [no-inner-declarations](http://eslint.org/docs/rules/no-inner-declarations.html) ([#587](https://github.com/eslint/eslint/issues/587))
* **Update:** The default value for the `vars` option of [no-unused-vars](http://eslint.org/docs/rules/no-unused-vars.html) was changed to "all". This addresses the issue where some were unexpectedly seeing unused global variables missed. ([#760](https://github.com/eslint/eslint/issues/760))
* **Update:** [valid-jsdoc](http://eslint.org/docs/rules/valid-jsdoc.html) now allows you to optionally turn off parameter description checks ([#822](https://github.com/eslint/eslint/issues/822))
* **Update:** [no-extra-parens](http://eslint.org/docs/rules/no-extra-parens.html) now doesn't flag IIFEs ([#655](https://github.com/eslint/eslint/issues/655))
* **Fix:** [semi](http://eslint.org/docs/rules/semi.html) rule was incorrectly flagging extra semicolon ([#840](https://github.com/eslint/eslint/issues/840))
* **Update:** Add "nofunc" option to [no-use-before-define](http://eslint.org/docs/rules/no-use-before-define.html) ([#829](https://github.com/eslint/eslint/issues/829))
* **Fix:** [block-scoped-var](http://eslint.org/docs/rules/block-scoped-var.html) correct scope for functions, arguments ([#832](https://github.com/eslint/eslint/issues/832))
...
* **Update:** Added `--rule` flag to specify rules on the [command line](http://eslint.org/docs/command-line-interface/). ([#692](https://github.com/eslint/eslint/issues/692))
...
* **Update:** [Contribution Guidelines](http://eslint.org/docs/developer-guide/contributing.html)
* **Update:** [Development Environment](http://eslint.org/docs/developer-guide/development-environment.html)
